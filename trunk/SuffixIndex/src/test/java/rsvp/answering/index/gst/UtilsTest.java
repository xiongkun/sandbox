...
public class UtilsTest extends TestCase
{
    ...
    public void testNormalize()
    {
        ...
        { "200 S Main St", "Lakeshore Dr.", "lake-view", "St. Jacob's Cathedral" };
        String[] outs = new String[]
        { "200smainst", "lakeshoredr", "lakeview", "stjacobscathedral" };
    ...
    public void testWriteInteger()
    {
        ...
        int expect = 1234567890;
        assertEquals(expect, Utils.toInteger(Utils.toBytes(expect)));
